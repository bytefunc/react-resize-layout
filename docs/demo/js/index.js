...
var _reactResizeLayout = __webpack_require__(27);
...
(0, _reactDom.render)(_react2.default.createElement(
    ...
    { handleWidth: "4px", handleColor: "#777" },
    _react2.default.createElement(
        _reactResizeLayout.ResizeHorizon,
        { className: "bg-green", width: "90px", minWidth: "0px" },
        _react2.default.createElement(
            _reactResizeLayout.Resize,
            _defineProperty({ handleWidth: "10px", handleColor: "red" }, "handleColor", "#000"),
            _react2.default.createElement(_reactResizeLayout.ResizeVertical, {
                className: "bg-white",
                height: "160px",
                minHeight: "10px"
            }),
            _react2.default.createElement(_reactResizeLayout.ResizeVertical, { className: "bg-green", minHeight: "10px" })
        )
    ),
    _react2.default.createElement(_reactResizeLayout.ResizeHorizon, { className: "bg-blue", width: "220px", minWidth: "20px" }),
    _react2.default.createElement(
        _reactResizeLayout.ResizeHorizon,
        { className: "bg-blue", width: "300px", minWidth: "150px" },
        _react2.default.createElement(
            _reactResizeLayout.Resize,
            { handleWidth: "4px", handleColor: "#eee" },
            _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement("img", { src: "./img/cat.jpg" })
            )
        )
    ),
    _react2.default.createElement(_reactResizeLayout.ResizeHorizon, { className: "bg-pink", minWidth: "0px" })
...
var _hammerjs = __webpack_require__(28);
...
var Resize = exports.Resize = function (_Component) {
    ...
    function Resize(props) {
        ...
        _this.getResize = _this.getResize.bind(_this);
        _this.getResizeInf = _this.getResizeInf.bind(_this);
        _this.moveHandleMouseStyle = _this.moveHandleMouseStyle.bind(_this);
        _this.eventHandle = _this.eventHandle.bind(_this);
        _this.initialResize = _this.initialResize.bind(_this);
        _this.initialVertical = _this.initialVertical.bind(_this);
        _this.initialHorizon = _this.initialHorizon.bind(_this);

        _this.resizeVertical = _this.resizeVertical.bind(_this);
        _this.resizeHorizon = _this.resizeHorizon.bind(_this);
        _this.windowResizeVertical = _this.windowResizeVertical.bind(_this);
        _this.windowResizeHorizon = _this.windowResizeHorizon.bind(_this);
        return _this;
    }
...
var ResizeVertical = exports.ResizeVertical = function (_Component2) {
    _inherits(ResizeVertical, _Component2);

    function ResizeVertical() {
        _classCallCheck(this, ResizeVertical);

        return _possibleConstructorReturn(this, (ResizeVertical.__proto__ || Object.getPrototypeOf(ResizeVertical)).apply(this, arguments));
    }
...
var ResizeHorizon = exports.ResizeHorizon = function (_Component3) {
    _inherits(ResizeHorizon, _Component3);

    function ResizeHorizon() {
        _classCallCheck(this, ResizeHorizon);

        return _possibleConstructorReturn(this, (ResizeHorizon.__proto__ || Object.getPrototypeOf(ResizeHorizon)).apply(this, arguments));
    }
